...
class EntityApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.entity_post_endpoint = _Endpoint(
            settings={
                'response_type': (EntityResponse,),
                'auth': [],
                'endpoint_path': '/entity',
                'operation_id': 'entity_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def entity_post(
        ...
        **kwargs
        ...
        """Get Entity Information  # noqa: E501

        Gets the balances and data objects at an entity at the current state of the ledger.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.entity_post(entity_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['entity_request'] = \
            entity_request
        return self.entity_post_endpoint.call_with_http_info(**kwargs)
