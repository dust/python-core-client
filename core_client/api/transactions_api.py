...
class TransactionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.transactions_post_endpoint = _Endpoint(
            settings={
                'response_type': (CommittedTransactionsResponse,),
                'auth': [],
                'endpoint_path': '/transactions',
                'operation_id': 'transactions_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'committed_transactions_request',
                ],
                'required': [
                    'committed_transactions_request',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'committed_transactions_request': 'body',
                },
    ...
    def transactions_post(
        ...
        **kwargs
        ...
        Returns an ordered sublist of committed transactions. This endpoint is designed for lite clients to sync with the state of the ledger.  The example response demonstrates a transfer transaction.  There is a more detailed worked example of reading this endpoint in the examples section.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.transactions_post(committed_transactions_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['committed_transactions_request'] = \
            committed_transactions_request
        return self.transactions_post_endpoint.call_with_http_info(**kwargs)
