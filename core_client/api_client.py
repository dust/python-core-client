...
from core_client import rest
from core_client.configuration import Configuration
from core_client.exceptions import ApiTypeError, ApiValueError, ApiException
from core_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ConstructionApi()
        api_instance.construction_build_post  # this is an instance of the class Endpoint
        api_instance.construction_build_post()  # this invokes api_instance.construction_build_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.construction_build_post.callable or self.callable in this class
