...
def lazy_import():
    ...
    globals()['EngineCheckpoint'] = EngineCheckpoint
    globals()['Fork'] = Fork


class EngineConfigurationResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'checkpoints': ([EngineCheckpoint],),  # noqa: E501
            'forks': ([Fork],),  # noqa: E501
        }
    ...
    attribute_map = {
        'checkpoints': 'checkpoints',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, checkpoints, forks, *args, **kwargs):  # noqa: E501
        """EngineConfigurationResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, checkpoints, forks, *args, **kwargs):  # noqa: E501
        """EngineConfigurationResponse - a model defined in OpenAPI
