...
class ConstructionFinalizeResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'signed_transaction': (str,),  # noqa: E501
        }
    ...
    attribute_map = {
        'signed_transaction': 'signed_transaction',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, signed_transaction, *args, **kwargs):  # noqa: E501
        """ConstructionFinalizeResponse - a model defined in OpenAPI

        Args:
            signed_transaction (str): Hex encoded signed transaction which can be submitted.
    ...
    @convert_js_args_to_python_args
    def __init__(self, signed_transaction, *args, **kwargs):  # noqa: E501
        """ConstructionFinalizeResponse - a model defined in OpenAPI
