...
def lazy_import():
    ...
    globals()['CommittedTransactionMetadata'] = CommittedTransactionMetadata
    globals()['OperationGroup'] = OperationGroup
    globals()['StateIdentifier'] = StateIdentifier
    globals()['TransactionIdentifier'] = TransactionIdentifier


class CommittedTransaction(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'committed_state_identifier': (StateIdentifier,),  # noqa: E501
            'operation_groups': ([OperationGroup],),  # noqa: E501
            'metadata': (CommittedTransactionMetadata,),  # noqa: E501
        }
    ...
    attribute_map = {
        ...
        'committed_state_identifier': 'committed_state_identifier',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, transaction_identifier, committed_state_identifier, operation_groups, metadata, *args, **kwargs):  # noqa: E501
        """CommittedTransaction - a model defined in OpenAPI

        Args:
            transaction_identifier (TransactionIdentifier):
            committed_state_identifier (StateIdentifier):
            operation_groups ([OperationGroup]): Transactions are split into operation groups which are roughly equivalent to ledger accounting entries where all credits have an equivalent debit amount.
        ...
        self.committed_state_identifier = committed_state_identifier
    ...
    @convert_js_args_to_python_args
    def __init__(self, transaction_identifier, committed_state_identifier, operation_groups, metadata, *args, **kwargs):  # noqa: E501
        """CommittedTransaction - a model defined in OpenAPI
