...
class OperationGroup(ModelNormal):
    ...
    def _from_openapi_data(cls, operations, *args, **kwargs):  # noqa: E501
        """OperationGroup - a model defined in OpenAPI

        Args:
            operations ([Operation]): A group of operations representing a complete state update.
        ...
        Keyword Args:
            ...
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Metadata for the operation group.. [optional]  # noqa: E501
        """
