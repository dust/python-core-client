...
class ConstructionParseRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, network_identifier, transaction, signed, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, network_identifier, transaction, signed, *args, **kwargs):  # noqa: E501
        """ConstructionParseRequest - a model defined in OpenAPI
