...
class Transaction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, transaction_identifier, operation_groups, metadata, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, transaction_identifier, operation_groups, metadata, *args, **kwargs):  # noqa: E501
        """Transaction - a model defined in OpenAPI
