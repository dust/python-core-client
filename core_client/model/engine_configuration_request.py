...
class EngineConfigurationRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, network_identifier, *args, **kwargs):  # noqa: E501
        """EngineConfigurationRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, network_identifier, *args, **kwargs):  # noqa: E501
        """EngineConfigurationRequest - a model defined in OpenAPI
