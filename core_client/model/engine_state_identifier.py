...
class EngineStateIdentifier(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, state_identifier, epoch, round, timestamp, *args, **kwargs):  # noqa: E501
        """EngineStateIdentifier - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, state_identifier, epoch, round, timestamp, *args, **kwargs):  # noqa: E501
        """EngineStateIdentifier - a model defined in OpenAPI
