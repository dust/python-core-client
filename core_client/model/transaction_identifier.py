...
class TransactionIdentifier(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'hash': (TransactionIdentifierHash,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, hash, *args, **kwargs):  # noqa: E501
        """TransactionIdentifier - a model defined in OpenAPI

        Args:
            hash (TransactionIdentifierHash):
