...
class MempoolResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'transaction_identifiers': ([TransactionIdentifier],),  # noqa: E501
        }
    ...
    attribute_map = {
        'transaction_identifiers': 'transaction_identifiers',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, transaction_identifiers, *args, **kwargs):  # noqa: E501
        """MempoolResponse - a model defined in OpenAPI

        Args:
            transaction_identifiers ([TransactionIdentifier]): List of transaction identifiers currently in the mempool.
    ...
    @convert_js_args_to_python_args
    def __init__(self, transaction_identifiers, *args, **kwargs):  # noqa: E501
        """MempoolResponse - a model defined in OpenAPI
