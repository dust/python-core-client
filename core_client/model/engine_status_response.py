...
class EngineStatusResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, engine_state_identifier, validator_set, *args, **kwargs):  # noqa: E501
        """EngineStatusResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, engine_state_identifier, validator_set, *args, **kwargs):  # noqa: E501
        """EngineStatusResponse - a model defined in OpenAPI
