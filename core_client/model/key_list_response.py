...
def lazy_import():
    ...
    globals()['PublicKeyEntry'] = PublicKeyEntry


class KeyListResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'public_keys': ([PublicKeyEntry],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, public_keys, *args, **kwargs):  # noqa: E501
        """KeyListResponse - a model defined in OpenAPI

        Args:
            public_keys ([PublicKeyEntry]): List of keys the node supports.
    ...
    @convert_js_args_to_python_args
    def __init__(self, public_keys, *args, **kwargs):  # noqa: E501
        """KeyListResponse - a model defined in OpenAPI
