...
def lazy_import():
    ...
    globals()['StakeUnitResourceIdentifier'] = StakeUnitResourceIdentifier
    globals()['StakeUnitResourceIdentifierAllOf'] = StakeUnitResourceIdentifierAllOf
    globals()['TokenResourceIdentifier'] = TokenResourceIdentifier


class StakeUnitResourceIdentifier(ModelComposed):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'validator_address': (str,),  # noqa: E501
            'type': (str,),  # noqa: E501
        }
    ...
    def discriminator():
        lazy_import()
        val = {
            'StakeUnit': StakeUnitResourceIdentifier,
            'Token': TokenResourceIdentifier,
        }
        if not val:
            return None
        return {'type': val}
    ...
    attribute_map = {
        'validator_address': 'validator_address',  # noqa: E501
        'type': 'type',  # noqa: E501
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """StakeUnitResourceIdentifier - a model defined in OpenAPI
