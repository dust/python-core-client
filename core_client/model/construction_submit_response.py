...
class ConstructionSubmitResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, transaction_identifier, duplicate, *args, **kwargs):  # noqa: E501
        """ConstructionSubmitResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, transaction_identifier, duplicate, *args, **kwargs):  # noqa: E501
        """ConstructionSubmitResponse - a model defined in OpenAPI
