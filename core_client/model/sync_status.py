...
class SyncStatus(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, current_state_version, target_state_version, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, current_state_version, target_state_version, *args, **kwargs):  # noqa: E501
        """SyncStatus - a model defined in OpenAPI
