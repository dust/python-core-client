...
class CommittedTransactionsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'state_identifier': (StateIdentifier,),  # noqa: E501
            'transactions': ([CommittedTransaction],),  # noqa: E501
        }
    ...
    attribute_map = {
        'state_identifier': 'state_identifier',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, state_identifier, transactions, *args, **kwargs):  # noqa: E501
        """CommittedTransactionsResponse - a model defined in OpenAPI

        Args:
            state_identifier (StateIdentifier):
            transactions ([CommittedTransaction]): A committed transactions list starting from the `state_identifier`.
    ...
    @convert_js_args_to_python_args
    def __init__(self, state_identifier, transactions, *args, **kwargs):  # noqa: E501
        """CommittedTransactionsResponse - a model defined in OpenAPI
