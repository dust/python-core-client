...
class NetworkNotSupportedErrorAllOf(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'supported_networks': ([NetworkIdentifier],),  # noqa: E501
        }
    ...
    attribute_map = {
        'supported_networks': 'supported_networks',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, supported_networks, *args, **kwargs):  # noqa: E501
        """NetworkNotSupportedErrorAllOf - a model defined in OpenAPI

        Args:
            supported_networks ([NetworkIdentifier]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, supported_networks, *args, **kwargs):  # noqa: E501
        """NetworkNotSupportedErrorAllOf - a model defined in OpenAPI
