...
class ParsedTransactionMetadata(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, fee, *args, **kwargs):  # noqa: E501
        """ParsedTransactionMetadata - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, fee, *args, **kwargs):  # noqa: E501
        """ParsedTransactionMetadata - a model defined in OpenAPI
