...
class ConstructionDeriveRequestMetadata(ModelNormal):
    ...
    def discriminator():
        ...
        val = {
            ...
            'ConstructionDeriveRequestMetadataAccount': ConstructionDeriveRequestMetadataAccount,
            'ConstructionDeriveRequestMetadataExitingUnstakes': ConstructionDeriveRequestMetadataExitingUnstakes,
            'ConstructionDeriveRequestMetadataPreparedStakes': ConstructionDeriveRequestMetadataPreparedStakes,
            'ConstructionDeriveRequestMetadataPreparedUnstakes': ConstructionDeriveRequestMetadataPreparedUnstakes,
            'ConstructionDeriveRequestMetadataToken': ConstructionDeriveRequestMetadataToken,
            'ConstructionDeriveRequestMetadataValidator': ConstructionDeriveRequestMetadataValidator,
            'ConstructionDeriveRequestMetadataValidatorSystem': ConstructionDeriveRequestMetadataValidatorSystem,
    ...
    def _from_openapi_data(cls, type, *args, **kwargs):  # noqa: E501
        """ConstructionDeriveRequestMetadata - a model defined in OpenAPI
