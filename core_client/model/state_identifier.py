...
class StateIdentifier(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, state_version, transaction_accumulator, *args, **kwargs):  # noqa: E501
        """StateIdentifier - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, state_version, transaction_accumulator, *args, **kwargs):  # noqa: E501
        """StateIdentifier - a model defined in OpenAPI
