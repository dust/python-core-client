...
class KeySignRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, network_identifier, unsigned_transaction, public_key, *args, **kwargs):  # noqa: E501
        """KeySignRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, network_identifier, unsigned_transaction, public_key, *args, **kwargs):  # noqa: E501
        """KeySignRequest - a model defined in OpenAPI
