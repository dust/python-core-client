...
class EngineIdentifier(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, engine, *args, **kwargs):  # noqa: E501
        """EngineIdentifier - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, engine, *args, **kwargs):  # noqa: E501
        """EngineIdentifier - a model defined in OpenAPI
